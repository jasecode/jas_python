...
CONFIG_PATH = os.path.join(os.path.dirname(__file__), 'config2.yml')
...
class Person:
    def __init__(self, name, email, wishlist, invalid_matches):
        ...
        # self.wishlist1 = wishlist[0]
        # self.wishlist2 = wishlist[1]
        # self.wishlist3 = wishlist[2]
...
def main(argv=None):
    ...
    try:
        ...
        for person in participants:
            # sizeofParticipants = len(participants)
            # for x in range (0,sizeofParticipants):
            name = " "
            email = " "
            wishlist = " "
            name = participants[x]['name']
            email = participants[x]['email']
            wishlist = participants[x]['wishlist']
    ...
    $ python secret_santa.py --send
        ...
        for pair in pairs:
            ...
            body = (HEADER+config['MESSAGE']).format(
                ...
                to=to,
                subject=subject,
                wishlist1=pair.reciever.wishlist[0],
                wishlist2=pair.reciever.wishlist[1],
                wishlist3=pair.reciever.wishlist[2],
